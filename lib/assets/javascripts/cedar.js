...
Cedar.Store.prototype.get = function ( object, key ) {
  ...
  var promise = $.getJSON(Cedar.config.api + object.apiGet + key, function(json) {
    if (typeof localStorage[key] === "undefined" ||
        JSON.parse(localStorage[key]).changeDate !== json.changeDate) {
      this.put(key, json);
    }
  }.bind(this));
...
Cedar.ContentEntry.apiGet = "/objects/contententries/";
Cedar.ContentEntry.apiQuery = "/queries/contententries/";
Cedar.ContentEntry.apiFilter = "guidfilter";
Cedar.ContentEntry.apiList = "guidlist";
